...
(function (Apriori) {
    ...
    var Algorithm = (function () {
        function Algorithm(minSupport, minConfidence, debugMode, iterations) {
            this.minSupport = minSupport ? minSupport === 0 ? 0 : minSupport : 0.1;
            this.minConfidence = minConfidence ? minConfidence === 0 ? 0 : minConfidence : 0.1;
        ...
        Algorithm.prototype.analyze = function (transactions) {
           ...
           // console.log(transactions);
            ...
            while (currentLItemSets.length !== 0) {
                ...
                itemSetSize += 1;
                if (itemSetSize >= self.iterations)
                	break;
            }
            if (self.debugMode) {
            ...
            var saveAssociationRuleIfFound = function (subsetItemSet) {
               ...
               // console.log(diffItemSet.length);
        ...
        Algorithm.prototype.showAnalysisResultFromFile = function (data) {
            var self = this;
            var transactions = data;
            var analysisResults = self.analyze(transactions);
           	//(analysisResults);
