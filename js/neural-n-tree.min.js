...
null!==o&&e.push(o),null!==l&&e.push(l)}i.push(r),n=e}return i},NNTFunctions.NeuralNTree.prototype.toJSON=function(){var t=[]
return this.__toJSON(this.rootNode,t),t.pop()},NNTFunctions.NeuralNTree.prototype.getHeight=function(t){return t?1+Math.max(this.getHeight(t.left),this.getHeight(t.right)):-1},NNTFunctions.NeuralNTree.prototype.__toJSON=function(t,i){if(t){var n={}
n.id=t.index+"_",n.children=[],n.name=t.point.join(", "),n.data={},i.push(n),this.__toJSON(t.left,n.children),this.__toJSON(t.right,n.children)}},NNTFunctions.NeuralNTree.prototype.levelUpdate=function(t,i){for(var n=this.levelOrder(t),e=n.length,r=0,o=n.length;r<o;r++)for(var l=0,s=n[r].length;l<s;l++)if(null!==n[r][l])for(var u=0,N=n[r][l].point.length;u<N;u++)n[r][l].point[u]=this.update(n[r][l].point[u],i[u],(r+1)/(e+1))},NNTFunctions.NeuralNTree.prototype.update=function(t,i,n){return t+this.alpha*(1/n)*(i-t)},NNTFunctions.NeuralNTree.prototype.cluster=function(t){t=NNTFunctions.util.convertRange(t,[this.min,this.max],[-2,2])
