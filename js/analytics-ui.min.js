...
t[a][r].mergeIndex&&(this.mergeIndices[t[a][r].mergeIndex]=!0),this.nodes.add({id:t[a][r].index,label:t[a][r].index,level:a,info:g,size:25,shape:"square",featureCount:0,color:j,nodeHeader:y,cid:t[a][r].mergeIndex}),null!==t[a][r].parent&&this.edges.add({from:t[a][r].index,to:t[a][r].parent.index})}var T=document.getElementById("neural-n-tree-visual"),S={nodes:this.nodes,edges:this.edges},D={edges:{smooth:{type:"cubicBezier",forceDirection:"vertical",roundness:.4}},layout:{hierarchical:{direction:"UD"}},physics:!1}
