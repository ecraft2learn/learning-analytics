...
var c={}
c.from=o.id,c.to=u.id,i[o.id]||s.push(o),i[u.id]||s.push(u),r.push(c),i[o.id]=!0,i[u.id]=!0}for(var d=0;d<t.length;d++){var l=t[d]
a+="<tr><td>"+l.lhs.join()+"</td><td>"+l.rhs.join()+"</td><td>"+l.confidence+"</td></tr>"}var h="<table id='freq-table' class='table'><thead><tr><th>Item</th><th>Support</th></tr></thead><tbody>"
for(var d in e)for(var p=e[d],m=0;m<p.length;m++){var g=p[m],v=g.itemSet.join(),b=g.support
h+="<tr><td>"+v+"</td><td>"+b+"</td></tr>"}h+="</tbody></table>"
var y={},f={nodes:s,edges:r},O=document.getElementById("apriori-table")
O.style.width="900px",O.style.height="900px",new vis.Network(O,f,y),$("#apriori-support-div").html(h),$("#freq-table").tablesorter(),$("#asso-table").tablesorter()}
