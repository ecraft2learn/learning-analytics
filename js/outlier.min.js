outlier={mean:null,covMatrix:null,num_rows:0,num_cols:0,testValx:null,initclassifier:function(r){var t=r.dimensions()
...
var t=outlier.mean,e=outlier.covMatrix,o=Math.pow(2*Math.PI,outlier.num_cols/2),i=Math.pow(e.det(),.5),n=outlier.testValx.subtract(t),u=$M(n),a=u.transpose(),l=e.inverse(),s=a.x(l)
return s=s.x(u),s=s.elements[0][0],s*=-.5,s=Math.exp(s),1/(o*i)*s},checkIfOutlier:function(r,t){t||(t=5e-4)
var e=outlier.getprobabValue(r),o=!1
return e<t&&(o=!0),o}}
